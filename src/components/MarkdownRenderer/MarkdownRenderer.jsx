...
const YearlyRoadmapTable = ({ roadmapData, lectureData }) => {
  return (
    <div style={{ overflowX: 'auto' }}>
      <h2 className="text-lg font-bold mb-4">Yearly Roadmap</h2>
      {roadmapData.yearRoadMap.monthPlans.map((plan, index) => (
        <div key={index} className="mb-6">
          <h3 className="text-md font-semibold mb-2">Month {plan.month}</h3>
      ...
      <h2 className="text-lg font-bold mb-4">Lecture Suggestions</h2>
